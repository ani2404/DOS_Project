...
void StepConfig(struct adc_csreg *pReg)
{
	...
	ADCStepConfig(pReg, 1, ADC_CHANNEL2, ADC_POSITIVE_REF_VDDA, ADC_CHANNEL2, ADC_NEGATIVE_REF_VSSA);
	ADCStepConfig(pReg, 2, ADC_CHANNEL3, ADC_POSITIVE_REF_VDDA, ADC_CHANNEL3, ADC_NEGATIVE_REF_VSSA);
	ADCStepConfig(pReg, 3, ADC_CHANNEL4, ADC_POSITIVE_REF_VDDA, ADC_CHANNEL4, ADC_NEGATIVE_REF_VSSA);
	ADCStepConfig(pReg, 4, ADC_CHANNEL5, ADC_POSITIVE_REF_VDDA, ADC_CHANNEL5, ADC_NEGATIVE_REF_VSSA);
	ADCStepConfig(pReg, 5, ADC_CHANNEL6, ADC_POSITIVE_REF_VDDA, ADC_CHANNEL6, ADC_NEGATIVE_REF_VSSA);
	ADCStepConfig(pReg, 6, ADC_CHANNEL7, ADC_POSITIVE_REF_VDDA, ADC_CHANNEL7, ADC_NEGATIVE_REF_VSSA);
	ADCStepConfig(pReg, 7, ADC_CHANNEL8, ADC_POSITIVE_REF_VDDA, ADC_CHANNEL8, ADC_NEGATIVE_REF_VSSA);
